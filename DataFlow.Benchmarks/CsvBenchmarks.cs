...
public class CsvBenchmarks
{
    ...
    [Benchmark]
    public int ReadCsvWithDataFlow()
    {
        var csvReader = new CsvReader(_csvFilePath);
        var pipeline = DataFlow.Core.DataFlow.From.Csv(_csvFilePath);
    ...
    [Benchmark]
    public List<DataRow> TransformCsvWithDataFlow()
    {
        var csvReader = new CsvReader(_csvFilePath);
        var pipeline = DataFlow.Core.DataFlow.From.Csv(_csvFilePath);
    ...
    public int LargeCsvProcessing()
    {
        ...
        var pipeline = DataFlow.Core.DataFlow.From.Csv(_largeCsvFilePath);
    ...
    [Benchmark]
    public void WriteCsvWithDataFlow()
    {
