...
namespace DataFlow.Tests
{
    public class ApiTests
    {
        ...
        [Fact]
        public void DataFlow_From_Api_CreatesValidPipeline()
        {
            var pipeline = DataFlow.Core.DataFlow.From.Api("https://api.example.com/test");
        ...
        [Fact]
        public void DataFlow_From_Api_WithConfiguration_CreatesValidPipeline()
        {
            var pipeline = DataFlow.Core.DataFlow.From.Api("https://api.example.com/test", api =>
            {
                api.WithAuth("token")
                   .WithRetry(2)
